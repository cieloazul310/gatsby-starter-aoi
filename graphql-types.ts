...
export type ShareButtonQueryVariables = {};


export type ShareButtonQuery = { site: Maybe<{ siteMetadata: Maybe<{ social: Maybe<Pick<SiteSiteMetadataSocial, 'github'>> }> }> };

export type SocialsQueryVariables = {};


export type SocialsQuery = { site: Maybe<{ siteMetadata: Maybe<{ social: Maybe<Pick<SiteSiteMetadataSocial, 'mail' | 'github' | 'twitter' | 'facebook' | 'gitlab' | 'medium' | 'linkedin' | 'pocket' | 'tumblr' | 'instagram' | 'vimeo' | 'youtube'>> }> }> };

export type LayoutQueryVariables = {};


export type LayoutQuery = { site: Maybe<{ siteMetadata: Maybe<Pick<SiteSiteMetadata, 'title' | 'lang' | 'description' | 'author'>> }> };
