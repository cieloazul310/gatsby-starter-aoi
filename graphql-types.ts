...
export type SiteMetadataQuery = { site: Maybe<{ siteMetadata: Maybe<(
      Pick<SiteSiteMetadata, 'title' | 'description' | 'author' | 'keywords' | 'lang'>
      & { social: Maybe<Pick<SiteSiteMetadataSocial, 'mail' | 'twitter' | 'github' | 'facebook' | 'gitlab' | 'linkedin' | 'medium' | 'pocket' | 'tumblr' | 'instagram' | 'vimeo' | 'youtube'>> }
    )> }> };
